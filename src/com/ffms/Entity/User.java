...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", username=" + username + ", password=" + password + ", truename=" + truename
				+ ", email=" + email + ", phone=" + phone + ", address=" + address + ", sex=" + sex + ", age=" + age
				+ ", appellation=" + appellation + ", salary=" + salary + ", card=" + card + ", isvalid=" + isvalid
				+ ", createtime=" + createtime + ", updatetime=" + updatetime + ", roleid=" + roleid + ", rolename="
				+ rolename + ", roleIDsList=" + roleIDsList + ", roleIDs=" + roleIDs + ", roleNames=" + roleNames + "]";
	}
