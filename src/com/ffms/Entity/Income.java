...
public class Income {
	...
	public String toString() {
		return "Income [id=" + id + ", userid=" + userid + ", roleid=" + roleid + ", incomer=" + incomer + ", source="
				+ source + ", money=" + money + ", dataid=" + dataid + ", content=" + content + ", incometime="
				+ incometime + ", createtime=" + createtime + ", updatetime=" + updatetime + ", datadicname="
				+ datadicname + ", datadicvalue=" + datadicvalue + ", username=" + username + ", starttime=" + starttime
				+ ", endtime=" + endtime + "]";
	}
